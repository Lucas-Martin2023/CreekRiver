    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "john@doe.com", "John", "Doe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://example.com/red-fox-image.jpg", "Red Fox" },
                    { 3, 3, "https://example.com/blue-jay-image.jpg", "Blue Jay" },
                    { 4, 4, "https://example.com/green-frog-image.jpg", "Green Frog" },
                    { 5, 1, "https://example.com/yellow-finch-image.jpg", "Yellow Finch" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2024, 2, 24, 12, 57, 50, 351, DateTimeKind.Local).AddTicks(648), new DateTime(2024, 2, 27, 12, 57, 50, 351, DateTimeKind.Local).AddTicks(714), 1 });
