...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20240224185750_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://example.com/red-fox-image.jpg",
                            Nickname = "Red Fox"
                        },
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://example.com/blue-jay-image.jpg",
                            Nickname = "Blue Jay"
                        },
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://example.com/green-frog-image.jpg",
                            Nickname = "Green Frog"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 1,
                            ImageUrl = "https://example.com/yellow-finch-image.jpg",
                            Nickname = "Yellow Finch"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2024, 2, 24, 12, 57, 50, 351, DateTimeKind.Local).AddTicks(648),
                            CheckoutDate = new DateTime(2024, 2, 27, 12, 57, 50, 351, DateTimeKind.Local).AddTicks(714),
                            UserProfileId = 1
                        });
                });
